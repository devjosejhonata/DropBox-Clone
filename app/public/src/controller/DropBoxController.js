class DropBoxController {
    ...
    constructor(){
        ...
        this.btnSendFileEl = document.querySelector('#btn-send-file'); //selecionando o botao para iniciar o evento
        this.inputFilesEl = document.querySelector('#files'); //forçando o clique nesse elemento
        this.snackModalEl = document.querySelector('#react-snackbar-root'); //mostrando o modal com a barra de progresso do upload
        ...
        this.initEvents();//criando o metodo para iniciar os eventos
    ...
    connectFirebase() {
                ...
                const firebaseConfig = {
                    apiKey: "AIzaSyBqfjJov81SrYUsplgftz3TLVuO1WMZzIk",
                    authDomain: "dropbox-clone-eaa4f.firebaseapp.com",
                    databaseURL: "https://dropbox-clone-eaa4f-default-rtdb.firebaseio.com",
                    projectId: "dropbox-clone-eaa4f",
                    storageBucket: "dropbox-clone-eaa4f.appspot.com",
                    messagingSenderId: "736716192444",
                    appId: "1:736716192444:web:27848c1e434000845a6eb9"
                };
    ...
    removeTask() {//metodo remover arquivos
    ...
    initEvents() {//chamando o metodo para iniciar os eventos
        ...
        //add o evento clique nesse nosso elemento, o btnSendFileEl

            this.inputFilesEl.click();//ao clicar no botao enviar arquivos, ja vai abrir a janela para fazer o files, anexar arquivo
    ...
    ajax(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart = function(){} ) {
        ...
        return new Promise((resolve, reject) => {
            ...
            let ajax = new XMLHttpRequest();
                ...
                ajax.open(method, url);//esse ajax vai para url
                ...
                ajax.onerror = (event) => {//se der algum erro chama o reject
    ...
    uploadTask(files) {//metodo que vai receber nossos arquivos

        let promises = []; //cada arquivo vai ter uma promessa, pode acontecer o upload ou falhar o upload

        [...files].forEach((file) => {//para cada arquivo que recebemos executamos essa função
        ...
        return Promise.all(promises)//retornando o array de promessas
    }

    uploadProgress(event, file) { //barra de progresso carregando
    ...
    getFileIconView(file) {// metodo para tratar o tipo do arquivo e icone que tenho que retornar
    ...
    getFileView(file, key) {// metodo para tratar o tipo do arquivo e icone que tenho que retornar
    ...
    readFiles() {//ler todos os arquivos
        ...
        //metodo que tras a referencia dos nossos files
    ...
    initEventsLi(li) {//evendo para selecionar os arquivos enviados
